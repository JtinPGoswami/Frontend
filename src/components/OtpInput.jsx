    ...
    <>
      {loading ? (
        ...
        <section className="flex flex-col justify-center items-center h-screen bg-background">
          <div className="   flex  flex-col gap-y-5 justify-center items-center xl:w-[30%] lg:w-[40%] md:w-[50%] sm:w-[60%] w-full sm:h-80 h-[50%] border border-gray-400 rounded-lg mx-auto">
            ...
            <Link className="float-end underline text-primary " to="/login">
              Go to login
            </Link>
            {message && (
